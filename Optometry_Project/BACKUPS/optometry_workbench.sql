...
--
-- Host: 127.0.0.1    Database: optometry
-- ------------------------------------------------------
...
CREATE TABLE `eye_exams` (
  ...
  `exam_results` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci,
...
CREATE TABLE `prescriptions` (
  ...
  `lens_type` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
...
-- Dump completed on 2025-09-03 21:16:58
